...
<!--导航区域结束-->
<div id="main">
    <form action="/Servlet/TeacherCheckServlet" method="post" class="main_form">
        <%--表头--%>
        <div id="data">
            <table id="datalist">
...
//                    }else
                    ...
                    String hql= "select new com.model.Iterm(i.iid,i.iname,i.mark,i.type,h.comment,h.time,h.hid) from Harvest h, Iterm i where h.iterms=i.iid and i.type!='辅德' and i.type!='辅体' and i.type!='辅智' and h.hid="+hid;
                ...
                %>
                <tr>
                    <th colspan="2"><b>项目详细</b></th>
                </tr>
                <tr>
                    <td class="title"><b>项目ID</b></td>
                    <td><%=i1%></td>
                </tr>
                <tr>
                    <td class="title"><b>项目名称</b></td>
                    <td><%=iname%></td>
                </tr>
                <tr>
                    <td class="title"><b>项目类型</b></td>
                    <td><%=type%></td>
                </tr>
                <tr>
                    <td class="title"><b>创建时间</b></td>
                    <td><%=time%></td>
                </tr>
                <tr>
                    <td class="title"><b>分数</b></td>
                    <td><%=mark%></td>
                </tr>
                <tr>
                    <td class="title"><b>项目状态</b></td>
                    <td><%=coment%></td>
                </tr>
                <%
                    }
