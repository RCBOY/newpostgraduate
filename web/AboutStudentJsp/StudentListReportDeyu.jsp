...
<div id="main">
    <form action="" method="post" class="main_form">
        ...
        <div id="data">
            <table id="datalist">
                <tr>
                    <td colspan="6" class="title"><b>德育分详情报表</b></td>
                </tr>
                <tr>
                    <th>项目ID</th>
                    <th>项目名称</th>
                ...
                <%
                    ...
                    String hql= "select new com.model.Iterm(i.iid,i.iname,i.mark,i.type,h.comment,h.time,h.hid) from Harvest h, Iterm i where  i.type!='体育分'and i.type!='智育分' and i.type!='体育基本分' and i.type!='智育基本分' and i.type!='辅体' and i.type!='辅智' and i.type!='绩点' and h.iterms=i.iid and h.student="+sid;
