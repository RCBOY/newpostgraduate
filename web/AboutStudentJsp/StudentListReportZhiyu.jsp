...
<div id="main">
    <form action="" method="post" class="main_form">
        ...
        <div id="data">
            <table id="datalist">
                <tr>
                    <td colspan="6" class="title"><b>智育分详情报表</b></td>
                </tr>
                <tr>
                    <th>项目ID</th>
                    <th>项目名称</th>
                ...
                <%
                    ...
                    if (grade.equals("研究生二年级")) {
                        hql = "select new com.model.Iterm(i.iid,i.iname,i.mark,i.type,h.comment,h.time,h.hid) from Harvest h, Iterm i where i.type!='体育分' and i.type!='德育分' and i.type!='体育基本分' and i.type!='德育基本分' and i.type!='辅体' and i.type!='辅德' and i.type!='绩点' and h.iterms=i.iid and h.student=" + sid;
                    }else {
                        hql = "select new com.model.Iterm(i.iid,i.iname,i.mark,i.type,h.comment,h.time,h.hid) from Harvest h, Iterm i where i.type!='体育分' and i.type!='德育分' and i.type!='体育基本分' and i.type!='智育基本分' and i.type!='德育基本分' and i.type!='辅体' and i.type!='辅德' and i.type!='辅智'  and h.iterms=i.iid and h.student=" + sid;
