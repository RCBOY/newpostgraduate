...
<div id="main">
    <form action="" method="post" class="main_form">
        ...
        <div id="data">
            <table id="datalist">
                <tr>
                    <td colspan="6" class="title"><b>辅导员评分详情</b></td>
                </tr>
                <tr>
                    <th>项目ID</th>
                    <th>项目名称</th>
...
//                        sid=student.getSid();
//                    }
                    String hql= "select new com.model.Iterm(i.iid,i.iname,i.mark,i.type,h.comment,h.time,h.hid) from Harvest h, Iterm i where i.type='辅导员'and h.iterms=i.iid and h.student="+sid;
        ...
        <div id="pages">
            <%
                ...
                {
            %>
            <a href="${pageContext.request.requestURI}?action=<%=i%>&&sid=<%=sid%>&&sid=<%=sid%>"><%=i%></a>
            <%
                }
            %>
            共<%=p%>页
