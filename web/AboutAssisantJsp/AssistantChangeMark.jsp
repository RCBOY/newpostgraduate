...
<!--主要区域开始-->
<div id="main">
    <form action="/Servlet/AssistantSearchServlet" method="post" class="main_form">
        <%--搜索--%>
        ...
        <div id="data">
            <table id="datalist">
                <tr>
                    <td class="title" colspan="5"><b>辅导员评分项</b></td>
                </tr>
                <tr>
                    <th>项目ID</th>
                    <th>项目名称</th>
                ...
                <%
                    ...
                    if (hql1==null) {
                        hql = "from Iterm i where i.type='辅体' or i.type='辅德' or i.type='辅智'";
                    }
                    else hql=hql1;
...
//                    int s1=Integer.parseInt(s);
                ...
                <tr>
                    ...
                    <td><%=iterm.getMark()%></td>
                    <td class="td_modi">
                        <a href="/Servlet/AssistantSubmitServlet?iid=<%=iterm.getIid()%>&&sid=<%=sid%>">申请</a>
                    </td>
                </tr>
                <%
                    }
