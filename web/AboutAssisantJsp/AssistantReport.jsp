        ...
        <div id="data">
            <table id="datalist">
                ...
                <%
                    if (listclose.size()==0)
                    {
                    String hqlgetstu="select new com.model.Student(s.sid,s.snum,s.sname,s.major,s.state,s.total) from Student s, Major m ,Assistant a where s.major=m.mid and s.assistant=a.aid and a.acc_num="+aname;
