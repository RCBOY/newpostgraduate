...
<div id="main">
    ...
    <form action="/Servlet/AdminPointTeacherServlet" method="post" class="main_form">
        <%--表结构--%>

        <div id="data">
            <table id="datalist">
                <tr>
                    <th colspan="3"><b>指定导师</b></th>
                </tr>
                <tr>
                    <th>年级</th>
                    <th>专业</th>
                ...
                <tr>
                    ...
                    <td>
                        <select onclick="" name="teacher" id="selModules3" class="select_search">
                            <%
                                String hql3="select distinct t.tname from Teacher t";
                                List<String> list3=baseDao.list(hql3);
                                String ass=null;
                                for (String teacher:list3){
                                    ass=teacher;
                            %>
                            <option><%=ass%></option>
                            <%
