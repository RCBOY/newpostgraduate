 ...
 */
public class AssistantChangeSubmitServlet extends HttpServlet {
...
//        RequestDispatcher requestDispatcher=request.getRequestDispatcher("/AboutAssisantJsp/CheckStudentSubmit.jsp?sid=" + session.getAttribute("sid"));
//        requestDispatcher.forward(request,response);
//        response.sendRedirect("/AboutAssisantJsp/CheckStudentSubmit.jsp?sid="+session.getAttribute("sid"));
    }else {
