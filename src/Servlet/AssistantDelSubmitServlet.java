...
/**
 * Created by 1234ztc on 2016/7/6.
 */
public class AssistantDelSubmitServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (listclose.size() ==0) {
            ...
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/AboutAssisantJsp/AssistantDelSubmit.jsp");
