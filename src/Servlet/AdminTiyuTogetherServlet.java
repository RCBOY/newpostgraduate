 ...
 */
public class AdminTiyuTogetherServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Object sid:sidlist) {
            ...
            String getIterm = "from Iterm i where i.type='体育基本分'";
        ...
        if (num==0) {
            JOptionPane.showMessageDialog(null, "体育分基本分添加成功", "提示", JOptionPane.PLAIN_MESSAGE);
